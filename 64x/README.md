## EN 
##### Here are simple scripts for installing 64 bit kernels in Debian and distributions based on it.
...
## RU
##### Здесь простые скрипты для установки 64 битных ядер в Debian и созданных на его базе дистрибутивах.
